      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <textarea name="descripcion" class="form-control" style="max-width:300px;text-align:center;" required 
            placeholder="Agrea una descripción del dominio"></textarea>
        </div>
      </div>
  	  <div class="col-md-4">
      ...
      <table width="90%" align="center" class="table table-striped " data-toggle="table">
        ...
        <tbody id="result" class="searchable">
          ...
          <tr>
            ...
            <td><span style="cursor:pointer" onclick="location.href='<?= base_url('dominio/ver/');?>/'+
              <?= $dominio->id;?>"><?= $dominio->descripcion;?></span></td>
