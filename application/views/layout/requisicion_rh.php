...
<body>
	<div class="container">
		...
		<div style="width:80%" class="container">
			...
			<?php if($requisicion->autorizador != $requisicion->director): ?>
				<p><b>Acepta: </b><?= $requisicion->nombre_director;?></p>
			<?php endif; ?>
			<p><b>Autoriza: </b><?= $requisicion->nombre_autorizador;?></p>
			...
			<p>Descarga <a target="_blank" href="http://localhost/advanzer/assets/docs/requisicion_<?= $requisicion->id;?>">aquí</a> el detalle en formato XLS</p>
		</div>
