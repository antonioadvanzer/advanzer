...
<body>
	<div class="container">
		...
		<div style="width:80%" class="container">
			...
			<h3><b>Nombre del Solicitante:</b> <b><?=$solicitud['nombre'];?></b></h3>
			<p><b>A quien va dirigida la carta: </b><?= $solicitud['person'];?></p>
			<p><b>Datos a contener: </b><br>
				<?= $solicitud['sueldo'] == "1" ? "Sueldo"."<br>" : ""; ?> 
				<?= $solicitud['imss'] == "1" ? "IMSS"."<br>" : ""; ?>
				<?= $solicitud['rfc'] == "1" ? "RFC"."<br>" : ""; ?>
				<?= $solicitud['curp'] == "1" ? "CURP"."<br>" : ""; ?>
				<?= $solicitud['antiguedad'] == "1" ? "Antiguedad"."<br>" : ""; ?>
				<?= $solicitud['puesto'] == "1" ? "Puesto"."<br>" : ""; ?>
				<?= $solicitud['domicilio'] == "1" ? "Domicilio Particular"."<br>" : ""; ?>
			</p>
