        ...
        <tbody id="result" class="searchable">
          ...
          <tr>
            ...
            <td><span class="glyphicon glyphicon-eye-open" style="cursor:pointer" onclick="
              location.href='<?= base_url('evaluacion/asignar_colaborador/');?>/'+<?= $ev->id;?>"></span> 
              <span style="cursor:pointer" onclick="location.href='<?= base_url('evaluacion/asignar_colaborador/');?>/'+
              <?= $ev->id;?>"><?= $ev->nombre;?></span></td>
            <td><span style="cursor:pointer" onclick="location.href='<?= base_url('evaluacion/asignar_colaborador/');?>/'+
