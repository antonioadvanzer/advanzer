...
<div class="jumbotron">
	<div class="container">
		<h2 style="cursor:default;">Revisión de la Evaluación - Nombre de la Evaluación<!--<?= $evaluacion->nombre;?>--></h2>
	</div>
</div>
<div class="container">
										...
										<div class="col-md-12">
											<div class="form-group" align="center">
												<h2><?= $resp->nombre;?><span style="min-width:100px;float:right;">
														<i>Respuesta</i>: 
														<select onchange="verify(this.form);" class="form-control" id="respuesta" disabled 
										...
										<div class="col-md-8">
											<div class="form-group" align="center">
												<textarea id="justificacion" class="form-control" rows="5" style="max-width:300px;text-align:center;
													...
													required disabled><?= $resp->justificacion;?></textarea>
											</div>
										</div>
									</label>
								<?php endforeach; ?>
				...
				<div style="width:60%;position:absolute;top:15%;z-index:20;left: 50%;width: 60%;margin-left: -30%;text-align: center;">
					<div class="col-md-12">
						<div class="form-group" align="center" id="finalizar">
							<label>Comentarios generales para el colaborador</label>
